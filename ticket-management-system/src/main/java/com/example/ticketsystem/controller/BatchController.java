...
public class BatchController {
    ...
    public ResponseEntity<BatchProcess> uploadFile(@RequestParam("file") MultipartFile file) {
        try {
            CompletableFuture<BatchProcess> futureProcess = batchService.processBatch(file);
            BatchProcess process = futureProcess.get(); // Espera pelo resultado
    ...
    public ResponseEntity<String> getBatchStats() {
        ...
        String stats = String.format("Total processado: %d, Sucessos: %d, Erros: %d", 
